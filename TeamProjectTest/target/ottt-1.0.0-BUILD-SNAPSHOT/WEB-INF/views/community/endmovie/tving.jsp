     ...
     <div class="wrap">
      ...
      <div id="line-2" >
        <nav class="nav2">
          ...
          <a class="nav-link2" href="<c:url value='/community/endmovie/tving' />"><img class="ott_icon" src="${path}/resources/images/icon/티빙.png" alt="tving"  style="border: 3px solid #33ff33; border-radius: 15px;"></a>
