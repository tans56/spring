     ...
     <div class="wrap">
      ...
      <div id="line-2" >
        <nav class="nav2">
          ...
          <a class="nav-link2" href="<c:url value='/community/endmovie/coupang' />"><img class="ott_icon" src="${path}/resources/images/icon/쿠팡플레이.png" alt="coupang" style="border: 3px solid #33ff33; border-radius: 15px;"></a>
